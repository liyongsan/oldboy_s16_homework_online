...
# sys.path.append(r"D:\script\python_s16\day7\homework\ftpserver")
...
class Myserver(socketserver.BaseRequestHandler):
    ...
    def authenticat(self,login_info): #认证用户
    ...
    def dir(self,command): #查看当前目录下的文件
        if len(command.split()) == 1:
    ...
    def __getdirsize(self,home_path): #统计目录空间大小
        size = 0
